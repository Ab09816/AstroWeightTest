const express = require("express"); //creates webserver
const path = require("path"); // handles files
const nightmare = require("nightmare"); // automates browser interactions
const expect = require("chai").expect; // assertion testing
